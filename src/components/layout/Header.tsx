...
export default function Header() {
  return (
    <header className="fixed top-0 w-full backdrop-blur-lg z-50 px-6 md:px-10 py-4">
      <div className="max-w-[1440px] mx-auto w-full flex flex-wrap md:flex-nowrap items-center gap-4 tracking-tighter">
